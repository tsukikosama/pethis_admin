     ...
     >
      ...
      <el-table-column
        ...
        <div class="pages">
          ...
          <el-dialog title="医生" class="myform" :visible.sync="dialogFormVisible" center>
              
              <div>
                <el-span>账号:</el-span><el-input v-model="saveitem.username"></el-input>
              </div>
              <div>
                <el-span>昵称:</el-span><el-input v-model="saveitem.nickname"></el-input>
              </div>
              <div>
                <el-span>职位:</el-span> <el-select v-model="saveitem.post" placeholder="请选择">
                      <el-option
              ...
              <div>
                <el-span>年龄:</el-span><el-input type="number" v-model="saveitem.age"></el-input>
              </div>
              <div>
  ...
  //   },
    ...
    methods: {
      ...
      submit(){
        ...
        request.post('/doctor/save',this.saveitem).then((res) =>{
      ...
      init(){
          request.get('/doctor/all').then((res) =>{
              this.all = res.data
      ...
      del(index,row){ 
        request.post('/doctor/remove?id='+row.id).then((res) =>{
